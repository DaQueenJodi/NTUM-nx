function scrUltras() {
	...
	ultra_tips[52] = "cannibalism"//morph gun creates two sheep cause logic (no balance)
	    ...
	    ultra_text[55] = "WHENEVER YOU HIT SOMEONE#WITH A THROWN WEAPON#THEY DROP EXTRA RADS#AND HAVE A CHANCE TO DROP EXTRA ITEMS#ALSO EXPLOSION ON HIT!##CHANCE PORTALS GIVE#YOU A HIGHER TIER WEAPON"
