function scrUltras() {
	...
	ultra_tips[52] = "cannibalism"//morph gun creates two sheep cause logic (no balance)
	    ...
	    ultra_text[55] = "WHENEVER YOU HIT AN ENEMY#WITH A THROWN WEAPON#THEY DROP EXTRA RESOURCES#WHEN A WEAPON RETURNS#IT FIRE A MASSIVE LASER##CHANCE PORTALS GIVE#YOU A HIGHER TIER WEAPON#THROWS BOUNCE TOWARDS ENEMIES"
