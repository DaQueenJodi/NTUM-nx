...
if point_distance(x,y,Player.x,Player.y) < 30+(Player.skill_got[3]*60)+Player.betterpluto or instance_exists(Portal) or instance_exists(TemporaryBuff)
{
...
if point_distance(x,y,Player.x,Player.y) < 30+(Player.skill_got[3]*60)+Player.betterpluto or instance_exists(Portal)
{
...
{
if point_distance(x,y,Implosion.x,Implosion.y) < 30+(Player.skill_got[3]*60)+Player.betterpluto or instance_exists(Implosion)
{
