draw_sprite(sprite_index,UberCont.opt_timer,x,y)

if mouse_check_button_pressed(mb_left) and mouse_x > x and mouse_x < x+8 and mouse_y > y and mouse_y < y+8
{
if UberCont.opt_timer = 0
UberCont.opt_timer = 1
else
UberCont.opt_timer = 0
...
draw_text(x+20,y,string_hash_to_newline("10"))