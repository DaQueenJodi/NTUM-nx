...
if (alarm[4] < 0) {
	...
	if instance_exists(projectile) && instance_exists(Player)
	{
	    ...
	    if point_distance(x,y,dodgethis.x,dodgethis.y) < 64 && dodgethis.team=2
	    {
		    ...
		    if point_distance(Player.x, Player.y, x, y) > 80 && (random(8)<1 || alarm[6] > 20 && random(2) < 1) && alarm[5] < 1 && (alarm[0]<1 || alarm[6] > 20) && alarm[2]<1 && projectiledir < gunangle+100 && projectiledir > gunangle-100 && dodgethis.typ!=0
