...
{
draw_sprite(sprRogueAmmoHUDTB,0,view_xview+116,view_yview+11)
draw_sprite(sprRogueAmmoHUDTB,Player.rogueammo,view_xview+116,view_yview+11)
}
else
{
...
{//42 more to -->
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+110,view_yview+16,col,1)
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+112,view_yview+16,col,1)
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+111,view_yview+15,col,1)
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+111,view_yview+17,col,1)
}

draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+110,view_yview+16,c_black,1)
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,max(0,wid*min(Player.wep_load[Player.cwep],Player.creload/Player.wep_load[Player.cwep])),14,view_xview+110,view_yview+16,c_white,0.2)
...
{
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+67,view_yview+16,col,1)
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+69,view_yview+16,col,1)
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+68,view_yview+15,col,1)
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+68,view_yview+17,col,1)
}

draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+68,view_yview+16,c_black,1)


draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,max(0,wid*min(Player.wep_load[Player.bwep],Player.breload/Player.wep_load[Player.bwep])),14,view_xview+68,view_yview+16,c_white,0.2)
...
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+25,view_yview+16,wepcolour,1)
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+23,view_yview+16,wepcolour,1)
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+24,view_yview+17,wepcolour,1)
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+24,view_yview+15,wepcolour,1)

draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,wid,14,view_xview+24,view_yview+16,c_black,1)
draw_sprite_part_smart(spr,1,sprite_get_xoffset(spr),sprite_get_yoffset(spr)-8,max(0,wid*min(Player.wep_load[Player.wep],Player.reload/Player.wep_load[Player.wep])),14,view_xview+24,view_yview+16,c_white,0.2)
