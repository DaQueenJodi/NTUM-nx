...
race_pass[7] = "LESS ACCURATE,FULLY AUTOMATIC WEAPONS"
...
race_pass[12] = "MINI AMMO PICKUPS#GIVE MORE AMMO#DEPENDING ON#THE AMOUNT OF BUDDIES#MORE HP CHESTS"
race_acti[12] = "LIL BUDDY"
race_butt[12] = "GAIN EVEN MORE AMMO#DEPENDING ON THE BUDDIES"
...
race_cskin_lock[12] = "FIX VENUZ'S CAR#WITH A GOLDEN SCREWDRIVER"


race_name[13] = "[SHEEP]"
race_pass[13] = "ENEMIES DON'T#ENGAGE FIRE ON YOU#UNTIL YOU DO"
...
race_name[14] = "[PANDA]"
race_pass[14] = "RANDOMISE YOUR WEAPON#TO ONE OF THE SAME TIER#EACH TIME YOU EXIT A PORTAL#THROWN WEAPONS TELEPORT BACK"
...
race_name[15] = "[ATOM]"
race_pass[15] = "ITEMS DESPAWN QUICKER#ENEMIES HAVE LESS HEALTH"
...
race_name[16] = "[VIKING]"
race_pass[16] = "GAIN ONE ARMOUR#AT THE START OF EACH LEVEL#TWO ARMOUR MAXIMUM"
race_acti[16] = "ARMOUR STRIKE"//ARMOUR STRIKE
race_butt[16] = "INCREASE MAX ARMOUR BY ONE#GAIN ONE EXTRA ARMOUR#AT THE START OF A LEVEL"
...
race_pass[17] = "START WITH#A RANDOM WEAPON MOD#"
race_acti[17] = "COMBINE BOTH WEAPONS INTO#A HIGHER TIER WEAPON"
...
race_lock[18] = "HAVE A SINGLE RUN WITH SECOND STOMACH,#BLOODLUST, RHINO SKIN AND STRONG SPIRIT"
race_have[18] = 0
race_swep[18] = 56
race_bskin[18] = 0
race_cskin[18] = 0
...
race_pass[19] = "4HP, SLOWER & LESS ACCURATE"
race_acti[19] = "BLOOD GAMBLE"
race_butt[19] = "HIGHER CHANCE TO NOT!#TAKE DAMAGE FROM BLOOD GAMBLE"
...
race_butt[21] = "BEAM CHARGES QUICKER#BEAM HEALS"//"STRONGER PORTAL STRIKE"
...
race_acti[24] = "TERRAFORM"//TERRAFORM
race_butt[24] = "LEVELS GENERATE MORE COVER#WALLS DEFLECT ENEMY PROJECTILES"
...
race_pass[25] = "SLIGHTLY MORE POWERFULL MUTATIONS#LESS RADIATION"//SLIGHTLY BETTER MUTATIONS# LEVELS SLOWER
race_acti[25] = "TURN LIFE INTO RADS"//
race_butt[25] = "YOUR ACTIVE#GIVES MORE RADS"
...
race_pass[26] = "WHENEVER YOU HIT SOMETHING#YOU BUILD UP SKILL#THE MORE SKILL YOU HAVE#THE HIGHER YOUR#DAMAGE AND ACCURACY IS#MISSING RESETS SKILL"
race_acti[26] = "SPRINT"//SPRINT
race_butt[26] = "WHEN YOU MISS A SHOT#YOUR SKILL DECREASES SLOWLY#AND HEALS YOU OVER TIME#THIS EFFECT STOPS#WHEN YOU HIT A SHOT AGAIN"
race_lock[26] = "BEAT BIG FISH"
race_have[26] = 0
race_swep[26] = 1
race_bskin[26] = 0
race_cskin[26] = 0
race_bskin_lock[26] = "COMPLETE A MAIN LEVEL#AFTER THE SEWERS#WITHOUT MISSING#AS GOOD OL'HUMPHRY"
race_cskin_lock[26] = "REACH 69 SKILL"
