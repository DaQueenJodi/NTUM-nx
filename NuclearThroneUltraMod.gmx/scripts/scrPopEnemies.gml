...
instance_create(x+16,y+16,ChesireCat);}
    ...
    {
    if random(3)<1
    instance_create(x+16,y+16,choose(CardGuy,CardGuy2,ExplosiveSheep,ExplosiveSheep,CardGuy,CardGuy2,ExplosiveSheep,ExplosiveSheep,TeaPot,TeaPot))
    }
    else
    {
    if random(8) < 1 
    ...
    {
    instance_create(x+16,y+16,choose(TeaPot,CardGuy,CardGuy,CardGuy,CardGuy2,CardGuy2,CardGuy2,ExplosiveSheep))}
    }
}
}
else{
