...
ultra_tips[4] = "is waterboost a thing now?"
    ...
    ultra_text[8] = "REFLECTED PROJECTILES#HOME IN ON ENEMIES#PUSH AWAY ENEMIES HARDER#LESS LASER DAMAGE WHILE SHIELDED"
...
ultra_tips[12] = "never miss a drop"
    ...
    ultra_text[16] = "THE ENEMY THAT DIES LAST IN A LEVEL#IS DEAD THE IN NEXT LEVEL#MORE BLOOD DAMAGE"
...
ultra_text[27] = "RIGHT CLICK FIRES YOUR PRIMARY"
...
ultra_tips[28] = "<3 bullets"
    ...
    ultra_name[29] = "REFINED TASTE"
    ultra_text[29] = "ONLY HIGH TIER WEAPON DROPS##AUTO EAT WEAPONS LEFT IN LEVEL"
    ultra_tips[29] = "delicacy"
    }
    }
    else{
    ...
    ultra_text[30] = "EATING WEAPONS HAS A CHANCE#TO DROP CHESTS##AUTO EAT WEAPONS LEFT IN LEVEL"
    ultra_tips[30] = "2% more chance for weapon chests"
    
    ultra_name[31] = "EXTRA STORAGE"
    ultra_text[31] = "YOU CAN CARRY THREE WEAPONS##AUTO EAT WEAPONS LEFT IN LEVEL"
    ultra_tips[31] = "can't choose"
    
    ultra_name[32] = "MULTI FUNCTIONAL"
    ultra_text[32] = "OCCASIONALLY PRODUCE LIGHTNING#EATING WEAPONS CREATES RADS & LIGHTNING##AUTO EAT WEAPONS LEFT IN LEVEL"
...
ultra_text[43] = "ALL PROJECTILES#MOVE TOWARDS YOUR MARKER"
ultra_tips[43] = "friendly fire?"

ultra_name[44] = "CRACK SHOT"
ultra_text[44] = "PLACE MULTIPLE MARKERS"
ultra_tips[44] = "gunslinger"
    ...
    ultra_name[47] = "SPAM"
    ultra_text[47] = "BUDDIES DECREASE ONLY#1/8 OF YOUR MAX HP"
...
ultra_tips[52] = "cannibalism"//morph gun creates two sheep cause logic (no balance)
    ...
    ultra_text[55] = "WHENEVER YOU HIT SOMEONE#WITH A THROWN WEAPON#THEY DROP EXTRA RADS#AND HAVE A CHANCE TO DROP EXTRA ITEMS##CHANCE PORTALS GIVE#YOU A HIGHER TIER WEAPON"
    ultra_tips[55] = "rise above"
    
    ultra_name[56] = "BLASPHEMY"
    ultra_text[56] = "MORE MELEE SPEED#YOU NO LONGER#GET RANDOM WEAPONS#AFTER EXITING A PORTAL"
    ultra_tips[56] = "survival above pacifism"
    
//ATOM 
ultra_name[57] = "NEUTRON"
ultra_text[57] = "BIGGER EXPLOSIONS#EXPLOSIONS DEAL MORE DAMAGE#AGAINST ENEMIES#EXPLOSIVE WEAPONS COST LESS AMMO"
...
ultra_tips[60] = "who needs hammerhead"
    ...
    ultra_name[62] = "ARMOUR UP"
    ultra_text[62] = "GAIN TWO ARMOUR EACH LEVEL#INSTEAD OF ONE#INCREASE ARMOUR MAX BY TWO"
    ultra_tips[62] = "tank up"
    }
    }
    else{
...
ultra_text[90] = "CONTINUOUSLY EMIT GAS"
...
ultra_tips[92] = "d"
    ...
    ultra_text[93] = "YOUR WALLS DO NOT GET DESTROYED#BY ENEMY PROJECTILES"
    ultra_tips[93] = "get to cover!"
    
    ultra_name[94] = "COLD HEART"
    ...
    ultra_name[96] = "THUNDER BOLT"
    ultra_text[96] = "D"
    ultra_tips[96] = "d"
    

//MUTATION SMITH 
ultra_name[97] = "WEAPON MUTATOR"
