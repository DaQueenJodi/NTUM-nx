...
if area < 100
lastarea = area
else if subarea = 1 || area = 105 || area = 106 || area = 107 || area = 101 || area = 110 || area = 111 || area = 112 || area = 103 || area = 109
{
if area = 103
{
    if subarea=1
...
if area = 109//inv wonderland bring to chesire cat
{
...
if area = 111//inv crystal cavesbring from caves to lill hunter
{
