...
with instance_create(x+lengthdir_x(Player.skill_got[13]*20,ang),y+lengthdir_y(Player.skill_got[13]*20,ang),BloodSlash)
{
ang = other.ang
...
with instance_create(x+lengthdir_x(Player.skill_got[13]*20,ang),y+lengthdir_y(Player.skill_got[13]*20,ang),FrostSlash)
{
ang = other.ang
dmg = 12
longarms = 0
...
if wep_type[wep] = 0 || wep = 24 || wep = 36 || wep = 53 || wep=198 || wep=37|| wep=126|| wep=108|| wep=109|| wep=123 || wep = 222|| wep=239//if wep_type[wep]==0 // You are holding a melee weapon
    {
    with projectile{
    if team=2&& typ=0{//if team is Player
...
//GAMEMODE UNLOCKABLES
if UberCont.opt_gamemode=0
{
/*
//ONE WEAPON ONLY GM UNLOCK 
if UberCont.gamemode_have[1]=0 && wep_rad[wep]>0
{
UberCont.gamemode_have[1]=1

with instance_create(x,y,UnlockPopup)
mytext=UberCont.gamemode[1]+ "#GAMEMODE UNLOCKED!#FOR USING AN ULTRA WEAPON"

with UberCont
scrSave();
}*/

//FAVOURABLE BUILD GAMEMODE
if UberCont.gamemode_have[2] = 0 && (wep = 24 || wep = 79 || wep = 12 || wep = 11 || wep = 234 || wep = 236 || wep = 197 || wep = 127 || wep = 128)//E Sword, SPC, SuCros, Auto crossy, heavy auto, super heavy auto, dubble super plasma cannon,Eswordgun,SEswordgun
{
UberCont.gamemode_have[2]=1

with instance_create(x,y,UnlockPopup)
mytext=UberCont.gamemode[2]+ "#GAMEMODE UNLOCKED!#FOR USING A FAVOURABLE WEAPON"
